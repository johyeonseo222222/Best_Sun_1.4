...
while start_date <= end_date:
    ...
    input_path_weather = os.path.join(folder_path, f'Weather_{start_date_str}_file_pre.csv')
...
#output_path_weather = fr"C:\Users\user1\Desktop\Battery_Charging_Algorithm\API\Weather_{start_date_str}_file.csv"  # 전처리 완료한 종관기상데이터 경로
    ...
    weather_save_file_name = f"Weather_{start_date_str}_file.csv"
    output_path_weather = os.path.join(user_desktop, 'Battery_Charging_Algorithm', 'API', weather_save_file_name)
...
user_desktop = os.path.join(os.path.expanduser('~'), 'Desktop')
folder_path = os.path.join(user_desktop, 'Battery_Charging_Algorithm', 'API')
input_path_forecast = os.path.join(folder_path, f"forecast_{end_date_str}_file_pre.csv")
...
forecast_save_file_name = f"forecast_{end_date_str}_file.csv"
output_path_forecast = os.path.join(user_desktop, 'Battery_Charging_Algorithm', 'API', forecast_save_file_name)
