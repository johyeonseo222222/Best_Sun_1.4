...
while start_date <= end_date:
    ...
    folder_path = os.path.join(user_desktop, 'Battery_Charging_Algorithm', 'API')
    observation_data_path = os.path.join(folder_path, fr'Weather_{start_date_str}_file.csv')
    print(observation_data_path)
...
forecast_data_path = os.path.join(folder_path, fr'forecast_{end_date_str}_file.csv')
...
train_x_data_path = os.path.join(base_path, 'df_x_train.csv')


#train_y_data_path =r"C:\Users\user1\Desktop\Battery_Charging_Algorithm\df_y_train.csv"

train_y_data_path = os.path.join(base_path, 'df_y_train.csv')
...
try:
    ...
    user_desktop = os.path.join(os.path.expanduser('~'), 'Desktop')
    results_save_file_name = f"{end_date_str}_battery_charging_file.csv"
    results_save_file_path = os.path.join(user_desktop, 'Battery_Charging_Algorithm', 'results', results_save_file_name)
    print(results_save_file_path)

    # 저장할 폴더가 없는 경우 생성
    results_save_directory = os.path.dirname(results_save_file_path)
    if not os.path.exists(results_save_directory):
        os.makedirs(results_save_directory)  # 폴더 생성
